...
struct ManagedContextScheduler<SchedulerTimeType, SchedulerOptions>: Scheduler
    ...
    SchedulerTimeType.Stride: SchedulerTimeIntervalConvertible
{
    ...
    func schedule(after _: SchedulerTimeType, interval _: SchedulerTimeType.Stride, tolerance _: SchedulerTimeType.Stride, options _: SchedulerOptions?, _ action: @escaping () -> Void) -> Cancellable {
        assertionFailure("future scheduling is not implemented")
        action()
        return AnyCancellable {}
    }

    func schedule(after _: SchedulerTimeType, tolerance _: SchedulerTimeType.Stride, options _: SchedulerOptions?, _ action: @escaping () -> Void) {
        assertionFailure("future scheduling is not implemented")
        action()
    }
}
...
typealias ManagedContextSchedulerOf<Scheduler> = ManagedContextScheduler<
