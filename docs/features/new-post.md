...
- **Sheet size on iPad.** On a regular-width iPad the composer sheet presents with medium/large detents and sits over the content at a comfortable width, rather than expanding to a full-screen modal.
