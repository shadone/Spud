...
- **Live and offline.** The landing and directory observe the local Explorer directory and update in place as it refreshes; with no network, the last bundled / fetched snapshot is shown.
