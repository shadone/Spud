...
- **Status:** planned
- **Related:** [Search](search.md), [Community screen](community-screen.md), [Subscribe / unsubscribe](subscribe-unsubscribe.md), [Subscriptions sidebar](subscriptions-sidebar.md), [Instance picker](instance-picker.md), [Signed-out browsing](signed-out-browsing.md), [Sign-in gate](sign-in-gate.md), [DESIGN-BRIEF.md](../design/DESIGN-BRIEF.md)
