...
| [Reminders](reminders.md) | `iphone`, `ipad` | partial — Phase 1: time-based "Remind Me…" reminders on a whole post (local OS notification + Inbox Reminders segment + tab badge); activity ("new comments") reminders and comment-subtree targeting are later phases |
