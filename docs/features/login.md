...
- **Status:** shipped
- **Related:** [Instance picker](instance-picker.md), [Registration](registration.md), [Accounts and switching](accounts-and-switching.md), [Signed-out browsing](signed-out-browsing.md), [Custom instance entry](custom-instance-entry.md), [DESIGN-BRIEF.md](../design/DESIGN-BRIEF.md)
